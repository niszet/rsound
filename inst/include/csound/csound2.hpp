...
struct PUBLIC pycbdata {
    ...
    PyObject *invalfunc;
    PyObject *outvalfunc;
    PyObject *midiinopenfunc;
    PyObject *midireadfunc;
    PyObject *midiinclosefunc;
    PyObject *hostdata;
...
struct Spinlocker {
    Spinlock &spinlock;
    Spinlocker(Spinlock &spinlock_);
    ~Spinlocker();
};

inline Spinlocker::Spinlocker(Spinlock &spinlock_) : spinlock(spinlock_)
{
    spinlock.lock();
}
